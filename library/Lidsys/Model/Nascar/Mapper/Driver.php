 ...
 * @author mlight
 */
class Lidsys_Model_Nascar_Mapper_Driver
extends Mephex_Model_Mapper_SequentialId
{
	 ...
	 * 
	 * @param $data
	 * @return Lidsys_Model_Nascar_Entity_Driver
	 */
	public function getMappedEntity($data)
	{
		$entity	= new Lidsys_Model_Nascar_Entity_Driver();
		$entity
			->setId($data['driverId'])
	 ...
	 *  
	 * @param Lidsys_Model_Nascar_Entity_Driver $entity
	 * @return array
	 */
