...
class Lidsys_Nascar_Accessor_Reader_TvStationTest
extends Lidsys_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_mapper	= new Lidsys_Nascar_Mapper_TvStation($this->_group);
		$this->_cache	= new Lidsys_Nascar_Cache_TvStation();
		$this->_stream	= new Lidsys_Nascar_Stream_Reader_TvStation($conn, $table_set);
		
		$this->_reader		= new Lidsys_Nascar_Accessor_Reader_TvStation(
			$this->_group,
			$this->_mapper,
			$this->_cache,
			$this->_stream
