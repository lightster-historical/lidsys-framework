...
class Lidsys_Nascar_Accessor_Writer_SeriesTest
extends Lidsys_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_istream	= new Lidsys_Nascar_Stream_Reader_Series($this->_conn, $this->_table_set);
		$this->_ostream	= new Lidsys_Nascar_Stream_Writer_Series($this->_conn, $this->_table_set);
		...
		$this->_writer	= new Lidsys_Nascar_Accessor_Writer_Series(
			$this->_group,
			$this->_mapper,
			$this->_cache,
			$this->_ostream
