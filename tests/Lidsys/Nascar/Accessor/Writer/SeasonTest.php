...
class Lidsys_Nascar_Accessor_Writer_SeasonTest
extends Lidsys_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->loadXmlDataSetIntoDb($this->_conn, 'Lidsys_Nascar', 'stream');
		
		$this->_group	= new Lidsys_Nascar_Accessor_Group($this->_conn, $this->_table_set);
		$this->_mapper	= new Lidsys_Nascar_Mapper_Season($this->_group);
		$this->_cache	= new Lidsys_Nascar_Cache_Season();
		
		$this->_istream	= new Lidsys_Nascar_Stream_Reader_Season($this->_conn, $this->_table_set);
		$this->_ostream	= new Lidsys_Nascar_Stream_Writer_Season($this->_conn, $this->_table_set);
		
		$this->_reader		= new Lidsys_Nascar_Accessor_Reader_Season(
			$this->_group,
			$this->_mapper,
			$this->_cache,
			$this->_istream
		);
		$this->_writer	= new Lidsys_Nascar_Accessor_Writer_Season(
			$this->_group,
			$this->_mapper,
			$this->_cache,
			$this->_ostream
