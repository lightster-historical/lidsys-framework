...
class Lidsys_Model_Nascar_Accessor_Reader_DriverTest
extends Lidsys_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_mapper	= new Lidsys_Model_Nascar_Mapper_Driver($this->_group);
		$this->_cache	= new Lidsys_Model_Nascar_Cache_Driver();
		$this->_stream	= new Lidsys_Model_Nascar_Stream_Reader_Driver($conn, $table_set);
		
		$this->_reader		= new Lidsys_Model_Nascar_Accessor_Reader_Driver(
			$this->_group,
			$this->_mapper,
			$this->_cache,
			$this->_stream
