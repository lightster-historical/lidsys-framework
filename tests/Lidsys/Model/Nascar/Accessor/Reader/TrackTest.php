...
class Lidsys_Model_Nascar_Accessor_Reader_TrackTest
extends Lidsys_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_mapper	= new Lidsys_Model_Nascar_Mapper_Track($this->_group);
		$this->_cache	= new Lidsys_Model_Nascar_Cache_Track();
		$this->_stream	= new Lidsys_Model_Nascar_Stream_Reader_Track($conn, $table_set);
		
		$this->_reader		= new Lidsys_Model_Nascar_Accessor_Reader_Track(
			$this->_group,
			$this->_mapper,
			$this->_cache,
			$this->_stream
